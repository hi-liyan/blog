...
![image-20201130224414488](https://upyun1.surcode.cn/imgs/20201130224414.png)

如果当前docker容器中已经存在Redis容器，则需要在harbor.yml中配置Redis，否则安装时会出错，提示已经存在Redis容器。*

![image-20201101151002963](https://upyun1.surcode.cn/imgs/20201101151003.png)
...
![image-20201101151221741](https://upyun1.surcode.cn/imgs/20201101151221.png)
