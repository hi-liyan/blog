...
<ShadowBox img='https://images.shiguangping.com/imgs/20201226010523.png' width='80%'/>

`go build -o 文件名`：自定义编译的文件名：

<ShadowBox img='https://images.shiguangping.com/imgs/20201226011221.png' width='80%' />
...
Go语言中的标识符由<MarkPen>字母、数字、下划线(_)</MarkPen>组成，并且只能以<MarkPen color='null' underline>字母或下划线</MarkPen>开头。如：`abc`、`_abc`、`_123`等。
