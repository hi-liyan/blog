...
> **Java SE -> 数据库（Mysql） -> 前端 -> Java EE -> 企业开发框架（Spring、Spring MVC、Mybatis、Spring Boot）**
...
一般JavaSE的视频教程在几十个小时左右，在选择视频的时候多点几个进去看看，货比三家嘛。找一个声音听着赏心悦目的老师，这样学习起码能事半功倍，有的视频可能你点进去就不想再听了，这种肯定是没法学习的。

还有一点是不宜选择时间过长的视频，有的教程几百个小时，这种最好是不要选了。

知道了教程的时长，根据时间给自己规划出一个学习周期，假设一个20小时的视频，一天看5个小时，其余时间用来练习和吸收，一周就把JavaSE攻克了。
