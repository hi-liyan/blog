...
![img](https://upyun1.surcode.cn/imgs/20210509131100.png)
...
![img](https://upyun1.surcode.cn/imgs/20210509100328.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![img](https://upyun1.surcode.cn/imgs/20210509100345.png)
...
![](https://upyun1.surcode.cn/imgs/20210509101241.png)

Client2发送消息：

![image-20210509101310728](https://upyun1.surcode.cn/imgs/20210509101501.png)

Client1会自动接收到来自channel1的消息：

![image-20210509101442837](https://upyun1.surcode.cn/imgs/20210509101447.png)
...
![image-20210509223138651](https://upyun1.surcode.cn/imgs/20210509223139.png)
...
![image-20210509231153470](https://upyun1.surcode.cn/imgs/20210509231153.png)
...
![image-20210509232400929](https://upyun1.surcode.cn/imgs/20210509232401.png)
...
![image-20210509233322505](https://upyun1.surcode.cn/imgs/20210509233322.png)
...
![image-20210511100350008](https://upyun1.surcode.cn/imgs/20210511100350.png)



`dbfilename`，快照文件名。

![image-20210511100449817](https://upyun1.surcode.cn/imgs/20210511100449.png)

`save`，保存快照的策略。

![image-20210511100616473](https://upyun1.surcode.cn/imgs/20210511100616.png)



`stop-writes-on-bgsave-error`，当Redis无法写入磁盘的话，直接关掉Redis的写操作。（推荐yes）

![image-20210511101840490](https://upyun1.surcode.cn/imgs/20210511101840.png)



`rdbcompression`，对于存储到磁盘中的快照，可以设置是否进行压缩存储。如果是的话，Redis会采用LZF算法进行压缩。

![image-20210511102032467](https://upyun1.surcode.cn/imgs/20210511102032.png)



`rdbchecksum`，在存储快照后，可以让Redis使用CRC64算法来进行数据完整性校验，但会增加大约10%性能上的消耗。

![image-20210511101948461](https://upyun1.surcode.cn/imgs/20210511101948.png)
...
![image-20210511105526183](https://upyun1.surcode.cn/imgs/20210511105526.png)



`appendfilename`，AOF存储文件的名子。

![image-20210511105727166](https://upyun1.surcode.cn/imgs/20210511105727.png)
...
![image-20210511111124115](https://upyun1.surcode.cn/imgs/20210511111124.png)
...
![image-20210511112908701](https://upyun1.surcode.cn/imgs/20210511112908.png)
