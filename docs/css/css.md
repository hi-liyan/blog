...
![image-20210808100845375](https://upyun1.surcode.cn/imgs/image-20210808100845375.png)
...
![image-20210808092249236](https://upyun1.surcode.cn/imgs/image-20210808092249236.png)
...
![image-20210808095418206](https://upyun1.surcode.cn/imgs/image-20210808095418206.png)
...
![image-20210808105232056](https://upyun1.surcode.cn/imgs/image-20210808105232056.png)
...
![image-20210808110111111](https://upyun1.surcode.cn/imgs/image-20210808110111111.png)
...
![image-20210808110747168](https://upyun1.surcode.cn/imgs/image-20210808110747168.png)
...
- 父元素宽度足够，所有子元素会按照HTML的书写顺序，依次向左进行贴边，父元素左边←子元素1←子元素2←子元素3←子元素4。
  ...
  ![image-20210808154052609](https://upyun1.surcode.cn/imgs/image-20210808154052609.png)

- 父元素宽度如果不够，例如不能放下子元素4，那么子元素4在贴边时，会跳过上一个子元素3，向更上一个子元素2进行贴边，如果子元素2后面位置不够，继续跳过子元素2向前面的子元素1进行贴边。

  ![image-20210808154521778](https://upyun1.surcode.cn/imgs/image-20210808154521778.png)

- 如果贴边的这个子元素4宽度小于子元素2，子元素2的高度低于子元素1和子元素3，形成一个凹陷，子元素4会受到前一个元素子元素3的高度影响，不会出现钻空现象。

  ![image-20210808154814541](https://upyun1.surcode.cn/imgs/image-20210808154814541.png)

- 如果子元素1后面的距离也放不下子元素4，子元素4最终会贴到父元素的左边，如果子元素4的宽度超过了父元素，只会出现溢出现象。

  ![image-20210808155032014](https://upyun1.surcode.cn/imgs/image-20210808155032014.png)

- 右浮动的效果与左浮动贴边效果是一致的，只是贴边的方向不同。按照HTML书写顺序依次向右上一个元素贴边，第一个元素贴父元素的右边。

  ![image-20210808155459923](https://upyun1.surcode.cn/imgs/image-20210808155459923.png)
...
![image-20210808163426642](https://upyun1.surcode.cn/imgs/image-20210808163426642.png)
...
![image-20210808165600870](https://upyun1.surcode.cn/imgs/image-20210808165600870.png)
...
![image-20210808165818506](https://upyun1.surcode.cn/imgs/image-20210808165818506.png)
...
![image-20210808170122383](https://upyun1.surcode.cn/imgs/image-20210808170122383.png)
...
![image-20210808171139905](https://upyun1.surcode.cn/imgs/image-20210808171139905.png)
...
![image-20210809085830128](https://upyun1.surcode.cn/imgs/image-20210809085830128.png)
...
![image-20210809091408571](https://upyun1.surcode.cn/imgs/image-20210809091408571.png)
...
![image-20210809102014935](https://upyun1.surcode.cn/imgs/image-20210809102014935.png)
...
![image-20210809154749127](https://upyun1.surcode.cn/imgs/image-20210809154749127.png)
...
![image-20210809174530873](https://upyun1.surcode.cn/imgs/image-20210809174530873.png)
...
![image-20210809174847984](https://upyun1.surcode.cn/imgs/image-20210809174847984.png)
...
![image-20210809175019881](https://upyun1.surcode.cn/imgs/image-20210809175019881.png)
...
![image-20210809175100392](https://upyun1.surcode.cn/imgs/image-20210809175100392.png)
...
![image-20210809184400207](https://upyun1.surcode.cn/imgs/image-20210809184400207.png)
...
![image-20210809185611139](https://upyun1.surcode.cn/imgs/image-20210809185611139.png)
...
![image-20210809190643169](https://upyun1.surcode.cn/imgs/image-20210809190643169.png)
