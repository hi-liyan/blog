...
<ImgBox src="https://upyun.shiguangping.com/imgs/20200426222802.png" width="450px" />

这也是类属性的另一种体现，所以Java推荐通过`类名.属性名`的方式调用，静态的调用方式。

<ImgBox src="https://upyun.shiguangping.com/imgs/20200426222954.png" width="450px" />
