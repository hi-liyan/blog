...
[Docker 安装手记](/docs/skill/docker-install)
...
仓库，仓库是用来存放镜像的，我们可以在仓库中拉取 (pull) 镜像，并运行容器。仓库分为[官方公共仓库](https://hub.docker.com/)和私有仓库两种，像阿里云等云服务商提供了私有 docker 镜像仓库，也可以自己[搭建私有仓库](/docs/skill/harbor-install)。
