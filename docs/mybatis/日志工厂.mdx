...
![image-20200617212307373](https://upyun1.surcode.cn/imgs/20200617212326.png)
...
![image-20200617210105215](https://upyun1.surcode.cn/imgs/20200617210105.png)

在执行`select * from user`查询语句后，控制台打印出日志信息：

![image-20200617210618104](https://upyun1.surcode.cn/imgs/20200617210618.png)
